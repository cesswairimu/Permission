...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regions_url, params: { region: { city_id: @region.city_id, code: @region.code, name: @region.name } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { city_id: @region.city_id, code: @region.code, name: @region.name } }
